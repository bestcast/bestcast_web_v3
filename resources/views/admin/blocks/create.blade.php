...
{{ Form::model('', ['route' => ['admin.blocks.createsave'], 'method' => 'post']) }}

<div class="small-grid">
    @include('admin.common.message')
    <h2 class="pb-2 border-bottom a-center">Create New Block</h2> <br>
    ...
    <div class="form-row a-center btnaction">
        ...
        <a href="{{ route('admin.blocks.index') }}" class="btn btn-secondary btn-lg backbtn">Back</a>
    </div>
</div>
