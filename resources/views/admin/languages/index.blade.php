...
@section('content')
    ...
    <h2 class="pb-3 border-bottom">
        Language <a href="{{ route('admin.languages.create') }}" class="btn btn-secondary float-right addnewbtn">+ Add New</a>
    </h2>
        ...
        <div class="col-4 col-xxl-3 ">
            <div class="card">
              <div class="card-body">
                ...
                <div class="card-act">
                    <a href="{{ route('admin.languages.edit',$item->id) }}" class="btn btn-primary btn-sm">Edit</a>
                  ...
                  @php ($delid=$item->id)
                  @php ($delurl=route('admin.languages.delete',$item->id))
