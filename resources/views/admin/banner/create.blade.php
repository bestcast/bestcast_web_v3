...
{{ Form::model('', ['route' => ['admin.banner.createsave'], 'method' => 'post']) }}

<div class="small-grid">
    @include('admin.common.message')
    <h2 class="pb-2 border-bottom a-center">Create New Banner</h2> <br>
    ...
    <div class="form-row a-center btnaction">
        ...
        <a href="{{ route('admin.banner.index') }}" class="btn btn-secondary btn-lg backbtn">Back</a>
    </div>
</div>
